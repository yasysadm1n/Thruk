...
Thruk::Controller::statusmap - Mojolicious Controller
...
sub add_routes {
    my($self, $app, $r) = @_;
    $r->any('/*/cgi-bin/statusmap.cgi')->to(controller => 'Controller::statusmap', action => 'index');
...
sub index {
    ...
    $c->stash->{_template}     = 'statusmap.tt';
